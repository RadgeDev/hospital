...
$this->phpexcel->getProperties()
			...
			$datos= $this->Lote_model->get_stockcritico();
...
$this->phpexcel->getProperties()
			...
			->setDescription('Stock');
			$datos= $this->Lote_model->get_stockminimo();
			$sheet=$this->phpexcel->getActiveSheet();
...
$this->phpexcel->getProperties()
			...
			$datos= $this->Lote_model->get_stockmaximo();
			$sheet=$this->phpexcel->getActiveSheet();
...
function reportebodegaminimo(){    
	$finalnombre="";
           ...
           $this->phpexcel->getProperties()
			...
			$datos= $this->Lote_model->get_stockbodegamin($codselec);
			$nombrebodega=$this->Lote_model->get_nombrebodega($codselec);
			$sheet=$this->phpexcel->getActiveSheet();
			$sheet->setTitle('Stock minimo');
			$style = array(
                         'alignment' => array(
...
{    
	$finalnombre="";
           ...
           $this->phpexcel->getProperties()
			...
			$datos= $this->Lote_model->get_stockbodegacri($codselec);
			$nombrebodega=$this->Lote_model->get_nombrebodega($codselec);
			$sheet=$this->phpexcel->getActiveSheet();
			$sheet->setTitle('Stock minimo');
			$style = array(
...
{    
	$finalnombre="";
           ...
           $this->phpexcel->getProperties()
            ->setTitle('Stock maximo')
			->setDescription('Stock maximo');
			$datos= $this->Lote_model->get_stockbodegamax($codselec);
			$nombrebodega=$this->Lote_model->get_nombrebodega($codselec);
			$sheet=$this->phpexcel->getActiveSheet();
			$sheet->setTitle('Stock maximo');
			$style = array(
