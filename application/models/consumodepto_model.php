...
class Consumodepto_model extends CI_Model {
  ...
  $this->db->select('Year(fecha) AS ano,MONTHNAME(CONCAT(fecha)) AS mes ,fecha,cod_producto ,bincard.nombre,cod_bodega,seccion as nombrebodega, Sum(salida) as totales');
  ...
  $this->db->where("cod_depto",$bodega);
 ...
 public function exportar($fechainicio= FALSE,$fechafin=FALSE,$bodega=FALSE)
