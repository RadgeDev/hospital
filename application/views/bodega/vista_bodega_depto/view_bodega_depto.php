<div id="page-wrapper">
 ...
 <div class="row">
         ...
         Consumo de Bodega Departamento
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i>   Consumo de Bodega Departamento
                            </li>
                        </ol>
                    </div>
                </div>
   <div class="row">
      ...
      <div class="col-md-4 ">
        ...
        <div class="panel-heading clearfix">
          ...
          <h3 class="panel-title">Encabezado de  Consumo de Bodega Departamento</h3>
        </div>
    ...
    <br>
      ...
      <div class="col-lg-3 col-sm-3">
            ...
            <button type="button " onclick="exportardatos();" class="form-control btn btn-info">  Exportar  </button>
