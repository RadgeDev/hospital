 ...
 <div class="row">
                ...
                Historial Egreso
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i>     Historial Egreso
                            </li>
                        </ol>
                    </div>
                </div>
   <div class="row">
      ...
      <div class="col-md-4 ">
        ...
        <div class="panel-heading clearfix">
          ...
          <h3 class="panel-title">Encabezado de Historial Egreso</h3>
        </div>
        ...
        <select name="buscando" id ="buscando" class="form-control" >
          <option value="nombre_depto">Nombre Depto/Serv</option>
        <option value="cod_salida">Codigo de engreso </option>
        <option value="num_pedido">N° Pedido</option>
