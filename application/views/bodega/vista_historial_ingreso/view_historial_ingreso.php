 ...
 <div class="row">
                ...
                Historial Ingreso
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i>     Historial Ingreso
                            </li>
                        </ol>
                    </div>
                </div>
   <div class="row">
      ...
      <div class="col-md-4 ">
        ...
        <div class="panel-heading clearfix">
          ...
          <h3 class="panel-title">Encabezado de     Historial Ingreso</h3>
        </div>
       ...
       <option value="tipo_compra_nombre">Tipo Compra Nombre</option>
        <option value="cod_compra">Codigo de Ingreso </option>
        <option value="numero_docuemento">N° Documento</option>
