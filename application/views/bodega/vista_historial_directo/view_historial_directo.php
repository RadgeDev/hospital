 ...
 <div class="row">
                ...
                Historial Compra Directa
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i>     Historial Compra Directa
                            </li>
                        </ol>
                    </div>
                </div>
   <div class="row">
      ...
      <div class="col-md-4 ">
        ...
        <div class="panel-heading clearfix">
          ...
          <h3 class="panel-title">Encabezado de Historial Compra Directa</h3>
        </div>
        ...
        <option value="cod_compra">Codigo Compra </option>
      ...
      <div class="col-md-12">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h4>  Historial Compra Directa</h4>
          </div>
