 ...
 <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Tipo Compra
                            </li>
                        </ol>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" >
                      ...
                      <form  id="formGuardar" role="form" action= "<?= base_url()?>control_tipo_compra/guardar " method="POST" >
                         <br>
                         <br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" >
                      ...
                      <form  id="formEditar" role="form" action= "<?= base_url()?>control_tipo_compra/actualizar" method="POST" >
                         <br>
                         <br>
                            <div class="form-group">
                               <label>Codigo</label>
