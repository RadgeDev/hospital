 ...
 <div class="row">
                ...
                Historial Pedidos
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i>     Historial Pedidos
                            </li>
                        </ol>
                    </div>
                </div>
   <div class="row">
      ...
      <div class="col-md-4 ">
        ...
        <div class="panel-heading clearfix">
          ...
          <h3 class="panel-title">Encabezado de Historial Pedidos</h3>
        </div>
        ...
        <select name="buscando" id ="buscando" class="form-control" >
          <option value="depto">Nombre Depto/Serv</option>
        <option value="tipo_pedido">Tipo Pedido </option>
        <option value="folio">N° Pedido</option>
        <option value="fecha">Fecha</option>
        <option value="nombre">Nombre Encargado</option>
        </select>
            </div>
